...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Sistema de Restricciones HF</title>
    ...
    <body class=" login">
            ...
            <form class="login-form" id="form1"  method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input id="username" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" /> </div>
                </div>
                <div class="form-group">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2018 &copy; Sistema de Restricciones</div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
