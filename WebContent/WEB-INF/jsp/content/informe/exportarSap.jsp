		...
		<div class="portlet-title">
			...
			<div class="btn-group" style="float: right;">
				...
				<ul class="dropdown-menu pull-right">
					<li><a href="/restPesticida/webApp/exportaCvs/1" > Export to SAP </a></li>
				...
				<table
					...
					<thead>
						<tr role="row" class="heading">
							...
							<th width="45%">LMR. Pesticidas</th>
							<th width="10%">&nbsp</th>
							
							<th width="15%">Certificaciones FS</th>
							<th width="15%">Certificación Organica</th>
							<th width="120px">Actions</th>
						</tr>
						<tr role="row" class="filter">
							<td><input type="text"
								class="form-control form-filter input-sm" name="vw_asuntoMail"></td>
