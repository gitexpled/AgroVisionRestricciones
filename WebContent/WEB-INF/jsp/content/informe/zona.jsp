					...
					<thead>
						...
						<tr role="row" class="filter">
							<td><input type="text"
								...
								class="form-control form-filter input-sm" name="vw_codProducto"  value=""></td>
							
							<td></td>-->
							<td><input type="text"
								class="form-control form-filter input-sm" name="vw_zona"  value="${IDFILTER}"></td>
							<td><input type="text"
