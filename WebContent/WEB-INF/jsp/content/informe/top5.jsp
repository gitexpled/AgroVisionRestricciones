				...
				<table
					...
					<thead>
						...
						<tr role="row" class="filter">
							<td><input type="text"
								class="form-control form-filter input-sm" name="vw_codProductor" value="${IDFILTER}"></td>
								
								
							
								<td><input type="text"
								class="form-control form-filter input-sm" name="vw_nMuestra" value="${NMUESTRA}"></td>
								<td></td>
								<td><input type="text"
								class="form-control form-filter input-sm" name="vw_d.codProducto" ></td>
							
							<td></td>
							
							<td><input type="text"
								class="form-control form-filter input-sm" name="vw_especie" value="${ESPECIE}" ></td><td></td>
