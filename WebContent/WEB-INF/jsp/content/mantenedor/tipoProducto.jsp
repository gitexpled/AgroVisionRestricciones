		...
		<div class="portlet-body">
			<div class="table-container">
				...
				<div class="table-actions-wrapper">
					<div class="btn-group">
						<button data-toggle="modal" data-target="#modal-newTipoProducto" id="sample_editable_1_new" class="btn green  btn-outline">
							Nueva Tipo Producto <i class="fa fa-plus"></i>
						</button>
					</div>
					<!-- <div class="btn-group">
				...
				<table
					...
					<thead>
						<tr role="row" class="heading">
							<th width="70%">Tipo Producto</th>
							<th width="30%">Actions</th>
						</tr>
						<tr role="row" class="filter">
							<td><input type="text"
								class="form-control form-filter input-sm" name="vw_tipoProducto">
							</td>
							<td>
