		...
		<div class="portlet-body">
			<div class="table-container">
				...
				<div class="table-actions-wrapper">
					<div class="btn-group">
						<button data-toggle="modal" data-target="#modal-newFuente"
							id="sample_editable_1_new" class="btn green  btn-outline">
							Agregar Mail <i class="fa fa-plus"></i>
						</button>
					</div>
					<!-- <div class="btn-group">
				...
				<table
					...
					<thead>
						...
						<tr role="row" class="filter">
							<td><input type="text"
								class="form-control form-filter input-sm" name="vw_mail">
							</td>
							<td>
							...
							<div class="col-md-8">
								<div class="input-icon right">
									<i data-container="body" data-original-title="Mail"
										...
										id="updateMail" name="updateMail" value=""
...
<div id="modal-newFuente" class="modal fade" tabindex="-1"
	aria-hidden="true">
	<div class="modal-dialog">
		<form id="form-InsertFuente" class="form-horizontal" role="form">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true"></button>
					<h4 class="modal-title">Nuevo Mail</h4>
				</div>
				<div class="modal-body">
									...
									<div class="input-inline input-large">
										<div class="input-group">
											<span class="input-group-addon" id="sizing-addon1">@</span> <input
												name="regMail" id="regMail" type="text"
