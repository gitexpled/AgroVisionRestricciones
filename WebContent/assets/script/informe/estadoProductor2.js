						           ...
						           ,
									...
									"render" : function(data, type, full,meta) {
										...
										if (data=='NO')
											...
											html="<a data-toggle='modal'  data-id='/AgroVisionRestricciones/json/detalleRest/"+colName+"/"+especie+"/"+full[1]+"/"+full[4]+"/"+full[5]+"/"+full[6].replace("'","@")+"'  href='#modal-informe' style='color:black'>PI<i class='fa fa-exclamation-circle'  style='font-size:14px;color:black'></i></a>";
										else
