	...
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {"url" : "/AgroVisionRestricciones/"+"json/restMercado/view"},
						"columnDefs" : [
{
	"targets" : [ 0 ],
	"render" : function(data, type, full) {
		...
		html="<a data-toggle='modal'  data-id='/AgroVisionRestricciones/json/detalleRest/"+full[1]+"/"+full[0]+"/"+especie+"' href='#modal-informe'>"+full[0]+"</a>";
		return html;
