	...
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/AgroVisionRestricciones/"+"json/cargaAutomatica/view", // ajax
																				// source
						},
						"columnDefs" : [
								{
									...
									"render" : function(data, type, full) {
										...
										html += "<a    class='col-md-6 btn grey btn-table  pull-right button-grilla-modifica-cuenta'   "
											+ "' target='_blank' href='/AgroVisionRestricciones/webApp/caData/"+full[5]+"'><i class='fa fa-database'></i></a> ";

										
										html += "<a  class='col-md-6 btn grey btn-table  pull-right button-grilla-modifica-cuenta' "
											+ "' target='_blank' href='/AgroVisionRestricciones/webApp/caExcel/"+full[5]+"'><i class='fa fa-file-excel-o'></i></a> ";
