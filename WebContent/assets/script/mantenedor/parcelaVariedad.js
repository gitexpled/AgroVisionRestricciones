var TableDatatablesAjax = function() {
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/AgroVisionRestricciones/"+"json/parcelaVariedad/view", // ajax
																				// source
						},
						"columnDefs" : [
								{
	...
	var drop = function(){
		$("body").on("click",".drop",function(e){
			...
			$.ajax({
				type : 'GET',
				url : "/AgroVisionRestricciones/"+"json/parcelaVariedad/drop",
				data : {
					id: id
				},
	...
	var obtener = function() {
		$("#modal-modifica-productor").on(
				...
				function(e) {
					...
					$.ajax({
						type : 'GET',
						url : "/AgroVisionRestricciones/json/parcelaVariedad/" + id,
						data : "",
						success : function(data) {
							console.log(data);
	...
	var editar = function() {
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/AgroVisionRestricciones/"+"json/parcelaVariedad/put",
									type : "PUT",
	...
	var insertProductor = function(){
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/AgroVisionRestricciones/"+"json/parcelaVariedad/insert",
									type : "PUT",
									data : JSON.stringify(row),
									beforeSend : function(xhr) {
										xhr.setRequestHeader("Accept",
