var TableDatatablesAjax = function() {
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/AgroVisionRestricciones/"+"json/turno/view", // ajax
																				// source
						},
						"columnDefs" : [
								{
	...
	var obtener = function() {
		$("#modal-modifica-productor").on(
				...
				function(e) {
					...
					$.ajax({
						type : 'GET',
						url : "/AgroVisionRestricciones/json/turno/" + id,
						data : "",
						success : function(data) {
							console.log(data);
	...
	var editar = function() {
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/AgroVisionRestricciones/"+"json/turno/put",
									type : "PUT",
	...
	var insertProductor = function(){
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/AgroVisionRestricciones/"+"json/turno/insert",
									type : "PUT",
									data : JSON.stringify(row),
									beforeSend : function(xhr) {
										xhr.setRequestHeader("Accept",
	...
	var drop = function(){
		$("body").on("click",".drop",function(e){
			...
			$.ajax({
				type : 'GET',
				url : "/AgroVisionRestricciones/"+"json/turno/drop",
				data : {
					id: id
				},
				success : function(data) {
