var TableDatatablesAjax = function() {
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/AgroVisionRestricciones/"+"json/habilitacionManual/view", // ajax
																				// source
						},
						"columnDefs" : [
								{
	...
	var setEstado = function(){
		$("body").on("click",".changeStatus",function(e){
			...
			$.ajax({
				type : 'GET',
				url : "/AgroVisionRestricciones/"+"json/habilitacionManual/delete",
				data : {
					id: id
				},
	...
	var obtener = function() {
		$("#modal-modifica").on(
				...
				function(e) {
					...
					$.ajax({
						type : 'GET',
						url : "/AgroVisionRestricciones/json/habilitacionManual/" + id,
						data : "",
						success : function(data) {
							console.log(data)
	...
	var editar = function() {
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/AgroVisionRestricciones/"+"json/habilitacionManual/put",
									type : "PUT",
									...
									success : function(data, textStatus, jqXHR) {
										...
										swal({
											  title: 'Habilitacion Manual Modificada exitosamente!',
											  animation: true,
											  customClass: 'animated tada'
											})
	...
	var insert = function(){
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/AgroVisionRestricciones/"+"json/habilitacionManual/insert",
									type : "PUT",
									data : JSON.stringify(row),
									beforeSend : function(xhr) {
										xhr.setRequestHeader("Accept",
									...
									swal({
										  title: 'Habilitacion Manual ingresada exitosamente!',
										  animation: true,
										  customClass: 'animated tada'
										})
										var table = $('#datatable_ajax')
