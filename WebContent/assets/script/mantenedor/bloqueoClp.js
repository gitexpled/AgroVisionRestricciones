var TableDatatablesAjax = function() {
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/AgroVisionRestricciones/"+"json/bloqueoClp/view", // ajax
																				// source
						},
						"columnDefs" : [
								{
	...
	var setEstado = function(){
		$("body").on("click",".changeStatus",function(e){
			...
			$.ajax({
				type : 'GET',
				url : "/AgroVisionRestricciones/"+"json/bloqueoClp/delete",
				data : {
					id: id
				},
	...
	var obtener = function() {
		$("#modal-modifica").on(
				...
				function(e) {
					...
					$.ajax({
						type : 'GET',
						url : "/AgroVisionRestricciones/json/bloqueoClp/" + id,
						data : "",
						success : function(data) {
							console.log(data)
	...
	var editar = function() {
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/AgroVisionRestricciones/"+"json/bloqueoClp/put",
									type : "PUT",
	...
	var insert = function(){
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/AgroVisionRestricciones/"+"json/bloqueoClp/insert",
									type : "PUT",
									data : JSON.stringify(row),
									beforeSend : function(xhr) {
										xhr.setRequestHeader("Accept",
									...
									swal({
										  title: 'CLP ingresado exitosamente!',
										  animation: true,
										  customClass: 'animated tada'
										})
										var table = $('#datatable_ajax')
