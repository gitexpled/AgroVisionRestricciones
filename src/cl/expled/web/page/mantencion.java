...
public class mantencion {
	...
	public ModelAndView caf(Model model, HttpSession httpSession) {
		...
		model.addAttribute("content", "folio");
		model.addAttribute("javaScriptPage", "mantencion-folio");
	...
	public ModelAndView cafContent(Model model, HttpSession httpSession) {
		...
		return new ModelAndView("content/folio");
	}

	// ADMINISTRACION DE CERTIFICADOS PFX
	@RequestMapping("/pfx")
	public ModelAndView pfx(Model model, HttpSession httpSession) {
		...
		model.addAttribute("content", "pfx");
		model.addAttribute("javaScriptPage", "mantencion-pfx");
	...
	public ModelAndView pfxContent(Model model, HttpSession httpSession) {
		...
		return new ModelAndView("content/pfx");
	}
